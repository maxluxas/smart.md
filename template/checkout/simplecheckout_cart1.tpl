...
<?php } ?>
    ...
    <?php foreach ($products as $product) { ?>
        <tr>
            ...
            <td class="total"><nobr style="color: #000;font-size: 36px;text-align: center;font-family: CFJackStory;"><?php echo $product['total']; ?> <?php echo $currency; ?></nobr></td>
            <td class="remove">
...
<?php foreach ($totals as $total) { ?>
    <div class="simplecheckout-cart-total" style="font-size: 22px;text-align: right;
margin-right: 40px;" id="total_<?php echo $total['code']; ?>">
        <span><b><?php echo $total['title']; ?></b></span>
        <span class="simplecheckout-cart-total-value"><nobr><?php echo $total['text']; ?> <?php echo $currency; ?></nobr></span>
...
<?php if (isset($modules['coupon'])) { ?>
    <div class="simplecheckout-cart-total" style="margin-top: 20px;margin-bottom: 20px;margin-right: 40px;">
        <span class="inputs"><?php echo $entry_coupon; ?>&nbsp;<input type="text" style="width: 100px;min-width: 110px;" name="coupon" value="<?php echo $coupon; ?>" onchange="simplecheckout_reload('coupon_changed')"  /></span>
        ...
        <style>#simplecheckout_button_cart {background:#ffcc33; color:#333;}#simplecheckout_button_cart:hover {background:#999; color:#fff;}</style>
		<?php } ?>
    </div>
<?php } ?>
</div>
