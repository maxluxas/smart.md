...
<table width="100%">
    ...
    <tr style="height:40px;">
     ...
     <tr style="height:40px;">
        ...
        <td><input required class="required" name='ctrlPaymentFirstDate' style="width:90px;" type='text' size='12' id='ctrlPaymentFirstDate_txtDate' placeholder="<?php echo $credit_zzllaa; ?>" title='Data primei rate - data când puteți incepe achitarea primei rate.
...
<div style="width: 130px;font-size: 16px;font-weight: bold;height: 28px;padding-top: 8px;border-radius: 4px;" class="button buletin-button"><?php echo $upload_button; ?></div>
          <input id="file" required style="margin-top: -65px;-moz-opacity: 0;filter: alpha(opacity=0);opacity: 0;height: 65px; cursor:pointer" name='fileAttach' class="button buletin-button required" type="file" />
		...
		<td vAlign='top' align='left' width='49%'>
			...
			<!-- Personal Information //-->
				...
				<tr>
					...
					<td width='100%'><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_FirstName' type='text' maxlength='30' id='tAP_FirstName' /></td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_LastName'><?php echo $credit_nume; ?></span></td>
					<td><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_LastName' type='text' maxlength='30' id='tAP_LastName' /></td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_FatherName'><?php echo $credit_patronimic; ?></span></td>
					<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_FatherName' type='text' maxlength='30' id='tAP_FatherName' /></td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_SEX'><?php echo $credit_gen; ?></span></td>
					<td>
                    <select name='sAP_SEX' id='sAP_SEX' onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };">
                    <option value=''></option>
				...
				<tr>
					...
					<td>
                    <input name='sAP_Nationality' type='text' value='MDA' style="width: 180px;height: 26px;background: #fffcce;border: 1px solid #ffcc33; margin: 0;padding: 0;border-radius:5px 5px 5px 5px;display: block!important;float: left;margin-top: 5px;padding-left: 5px;" id='sAP_Nationality' class='LOV' readonly />
                    </td>
				</tr>
				<tr>
					<td noWrap style=""><span class="credit-fields" id='lAP_IdentityCard'><?php echo $credit_nr_buletin; ?></span></td>
					<td>
					<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_IdentityCard' type='text' maxlength='9' id='tAP_IdentityCard' />
					</td>
				</tr>
				<tr>
					<td noWrap style=""><span class="credit-fields" id='lAP_ICExpiryDate'><?php echo $credit_data_exp; ?></span></td>
					<td class='Date'>
					<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='ctrlAP_ICExpiryDate' type='text' size='12' id='ctrlAP_ICExpiryDate_txtDate' placeholder="<?php echo $credit_data_exp_val; ?>" title='<?php echo $credit_data_exp_val; ?>' style='' />
					</td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_UIN'><?php echo $credit_cod_personal; ?></span></td>
					<td><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_UIN' type='text' maxlength='13' id='tAP_UIN' />
					</td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_Birth'><?php echo $credit_data_nasterii; ?></span></td>
					<td class='Date'>
					<input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='ctrlAP_BirthDate' type='text' size='12' id='ctrlAP_BirthDate_txtDate' placeholder="<?php echo $credit_zzllaa; ?>" title='<?php echo $credit_zzllaa; ?>' style='' />
					</td>
				</tr>
				<tr>
					<td noWrap style=""><span id='lAP_MARRITAL_STATUS'><?php echo $credit_casatorit; ?></span></td>
					<td>
                    <select name='sAP_MARRITAL_STATUS' id='sAP_MARRITAL_STATUS' onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };">
                    <option value=''></option>
...
<h1><?php echo $credit_adresa_domiciliu; ?></h1>
									...
									<tr>
									  ...
									  <td><input name="tAP_CA_Country" type="text" value="10005" id="tAP_CA_Country" style="visibility:hidden; position:absolute;" /><input name="tAP_CA_CountryDesc" readonly type="text" value="MOLDOVA"  id="tAP_CA_CountryDesc" style="background: #fffcce;border: 1px solid #ffcc33;" class="LOV" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_Region"><?php echo $credit_regiune; ?></span></td>
										<td><input name="tAP_CA_Region" type="text" id="tAP_CA_Region" style="visibility:hidden; position:absolute;" /><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_RegionDesc" type="text"  id="tAP_CA_RegionDesc" class="LOV" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_City"><?php echo $credit_oras; ?></span></td>
									  <td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_City" type="text" maxlength="30" id="tAP_CA_City" class="LOV" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_Street"><?php echo $credit_strada; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_Street" type="text" maxlength="100" id="tAP_CA_Street" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_Block"><?php echo $credit_nr_cladirii; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_Block" type="text" maxlength="10" id="tAP_CA_Block" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_AppartmentNum"><?php echo $credit_nr_apart; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_AppartmentNum" type="text" maxlength="10" id="tAP_CA_AppartmentNum" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_Phone"><?php echo $credit_tel_fix; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_Phone" type="text" maxlength="15" id="tAP_CA_Phone" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_Mobile"><?php echo $credit_tel_mob; ?></span></td>
										<td><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_Mobile" type="text" maxlength="15" id="tAP_CA_Mobile" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_email"><?php echo $credit_email; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_email" type="text" maxlength="30" id="tAP_CA_email" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_CA_CurYearAddress"><?php echo $credit_ani_adresa; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_CA_CurYearAddress" type="text" maxlength="3" id="tAP_CA_CurYearAddress" class="Num" /></td>
									</tr>
									<tr>
										<td style=""><span id="lAP_CA_HomeOwnership"><?php echo $credit_loc_propr; ?></span></td>
										<td><select onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="sAP_CA_HomeOwnership" id="sAP_CA_HomeOwnership">
	<option value=""></option>
...
<h1><?php echo $credit_info_munca; ?></h1>
									...
									<tr>
										...
										<td width='100%'><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_Company' type='text' maxlength='30' id='tAP_JO_Company' /></td>
									</tr>
									<tr>
										<td style="">
											<span id='lAP_JOB_FIELD_ACTIVITY'><?php echo $credit_dom_activitate; ?></span></td>
										<td>
											<select onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='sAP_JOB_FIELD_ACTIVITY' id='sAP_JOB_FIELD_ACTIVITY'>
    <option value=''></option>                                        
	...
	<option value='Privat / Straina - Altele'><?php echo $credit_privstrain_alte; ?></option>
									...
									<tr>
										...
										<td noWrap><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_PROFESSION_OTHER' type='text' id='tAP_JO_PROFESSION_OTHER' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_JO_ContractType'><?php echo $credit_tip_contract; ?></span></td>
										<td><select name='sAP_JO_ContractType' onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" id='sAP_JO_ContractType'>
	<option value=''></option>
	...
	<option value='Temporar'><?php echo $credit_temporar; ?></option>
									...
									<tr>
										...
										<td class='Date'>
			<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='ctrlAP_JO_HireDate' type='text' size='12' id='ctrlAP_JO_HireDate_txtDate' placeholder="<?php echo $credit_zzllaa; ?>" title='<?php echo $credit_zzllaa; ?>' style='' />
</td>
									</tr>

									<tr>
										<td noWrap style=""><span class="credit-fields" id='lAP_JO_WorkYears'><?php echo $credit_nranifunctia; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_WorkYears' type='text' maxlength='2' id='tAP_JO_WorkYears' class='Num' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_JO_Country'><?php echo $credit_tara; ?></span></td>
										<td>
                                        <input name='tAP_JO_Country' type='text' value='MOLDOVA' style="width: 180px;height: 26px;background: #fffcce;border: 1px solid #ffcc33;margin: 0;padding: 0;border-radius:5px 5px 5px 5px;display: block!important;float: left;margin-top: 5px;padding-left: 5px;" id='tAP_JO_Country' class='LOV' readonly /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_JO_Region'><?php echo $credit_regiune; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_Region' type='text' id='tAP_JO_Region' class='LOV' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_JO_City'><?php echo $credit_oras; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_City' type='text' maxlength='30' id='tAP_JO_City' class='LOV' /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_Phone' type='text' maxlength='15' id='tAP_JO_Phone' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_JO_Mobile'><?php echo $credit_tel_mob; ?></span></td>
										<td><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_JO_Mobile' type='text' maxlength='15' id='tAP_JO_Mobile' /></td>
									</tr>
...
<h1><?php echo $credit_persoana_conact; ?></h1>
									...
									<tr>
										...
										<td style=""><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_FirstName' type='text' maxlength='30' id='tCP_FirstName' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_LastName'><?php echo $credit_nume; ?></span></td>
										<td style=""><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_LastName' type='text' maxlength='30' id='tCP_LastName' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_FatherName'><?php echo $credit_patronimic; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_FatherName' type='text' maxlength='30' id='tCP_FatherName' /></td>
									</tr>									
									<tr>
										<td noWrap style=""><span id='lCP_Country'><?php echo $credit_tara; ?></span></td>
										<td style=""><input name='tCP_Country' type='text' value='MOLDOVA' style="width: 180px;height: 26px;background: #fffcce;border: 1px solid #ffcc33;margin: 0;padding: 0;border-radius:5px 5px 5px 5px;display: block!important;float: left;margin-top: 5px;padding-left: 5px;" id='tCP_Country' class='LOV' readonly /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_Region'><?php echo $credit_regiune; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_Region' type='text' id='tCP_Region' class='LOV' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_City'><?php echo $credit_oras; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_City' type='text' maxlength='30' id='tCP_City' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_Street'><?php echo $credit_strada; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_Street' type='text' maxlength='100' id='tCP_Street' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_Block'><?php echo $credit_nr_cladirii; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_Block' type='text' maxlength='10' id='tCP_Block' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_AppartmentNum'><?php echo $credit_nr_apart; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_AppartmentNum' type='text' maxlength='10' id='tCP_AppartmentNum' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_Phone'><?php echo $credit_tel_fix; ?></span></td>
										<td style=""><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_Phone' type='text' maxlength='15' id='tCP_Phone' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lCP_Mobile'><?php echo $credit_tel_mob; ?></span></td>
										<td style=""><input required class="required" onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tCP_Mobile' type='text' maxlength='15' id='tCP_Mobile' /></td>
									</tr>
...
<div id="lblSameAsCurrent" style="margin-left: 14px;width: 403px;text-align: left;margin-top: 10px;margin-bottom: 10px;"><input id="chkSameAsCurrent" type="checkbox" name="chkSameAsCurrent" onClick="javascript:EnableDisable();" style="width: 15px;height: 12px;margin-left: -15px;margin-top: 2px;position: absolute;text-align: left;" />&nbsp;<?php echo $credit_adresa_identic; ?></div>
									...
									<tr>
									  ...
									  <td style=""><input name="tAP_BA_Country" type="text" value="10005" id="tAP_BA_Country" style="visibility:hidden; position:absolute;background: #fffcce;border: 1px solid #ffcc33;" /><input name="tAP_BA_CountryDesc" type="text" value="MOLDOVA" style="background: #fffcce;border: 1px solid #ffcc33;" readonly id="tAP_BA_CountryDesc" class="LOV" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_Region"><?php echo $credit_regiune; ?></span></td>
									  <td style=""><input name="tAP_BA_Region" type="text" id="tAP_BA_Region" style="visibility:hidden; position:absolute;" /><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_RegionDesc" type="text"  id="tAP_BA_RegionDesc" class="LOV" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_City"><?php echo $credit_oras; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_City" type="text" maxlength="30" id="tAP_BA_City" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_Street"><?php echo $credit_strada; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_Street" type="text" maxlength="100" id="tAP_BA_Street" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_Block"><?php echo $credit_nr_cladirii; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_Block" type="text" maxlength="10" id="tAP_BA_Block" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_AppartmentNum"><?php echo $credit_nr_apart; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_AppartmentNum" type="text" maxlength="10" id="tAP_BA_AppartmentNum" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_Phone"><?php echo $credit_tel_fix; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_Phone" type="text" maxlength="15" id="tAP_BA_Phone" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_Mobile"><?php echo $credit_tel_mob; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_Mobile" type="text" maxlength="15" id="tAP_BA_Mobile" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_CurYearAddress"><?php echo $credit_ani_adresa; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="tAP_BA_CurYearAddress" type="text" maxlength="3" id="tAP_BA_CurYearAddress" class="Num" /></td>
									</tr>
									<tr>
										<td style="" nowrap=""><span id="lAP_BA_HomeOwnership"><?php echo $credit_loc_propr; ?></span></td>
										<td style=""><select onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name="sAP_BA_HomeOwnership" id="sAP_BA_HomeOwnership">
    <option value=""></option>
    <option value="<?php echo $credit_da; ?>"><?php echo $credit_da; ?></option>
	<option value="<?php echo $credit_da_mostenire; ?>"><?php echo $credit_da_mostenire; ?></option>
	<option value="<?php echo $credit_nu_inch; ?>"><?php echo $credit_nu_inch; ?></option>
...
<h1><?php echo $credit_info_sot; ?></h1>
									...
									<tr>
										...
										<td style="">
											<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_SP_FirstName' type='text' maxlength='30' id='tAP_SP_FirstName' />
									...
									<tr>
										...
										<td style="">
											<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_SP_LastName' type='text' maxlength='30' id='tAP_SP_LastName' />
...
<table border='0' cellpadding='0' cellspacing='0' style='BORDER-COLLAPSE: separate' >
	<tr>
		<td align='left' valign='top' nowrap>
			<input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='ctrlAP_SP_BirthDate' type='text' size='12' id='ctrlAP_SP_BirthDate_txtDate' placeholder="<?php echo $credit_zzllaa; ?>" title='<?php echo $credit_zzllaa; ?>' style='' />
...
<h1><?php echo $credit_info_fam; ?></h1>
									...
									<tr>
										...
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_DependantChildren' type='text' maxlength='2' id='tAP_DependantChildren' class='Num' /></td>
									</tr>
									<!-- Spouse Information //-->
                                    <TR>
										<td colspan="2" style="border-bottom:1px solid #ccc;">&nbsp;</td> 
...
<h1><?php echo $credit_info_fin; ?></h1>
									...
									<tr>
										...
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_FI_NetIncome' type='text' maxlength='20' id='tAP_FI_NetIncome' class='Num' /></td>
									</tr>
									<tr>
										<td noWrap style=""><span id='lAP_FI_SpouseNetIncome'><?php echo $credit_info_venit_sot; ?></span></td>
										<td style=""><input onBlur="if(this.value.length &gt; 0) { this.parentNode.className='input done'} else { this.parentNode.className='input' };" name='tAP_FI_SpouseNetIncome' type='text' maxlength='20' id='tAP_FI_SpouseNetIncome' class='Num' /></td>
									</tr><TR>
...
<input onclick="_gaq.push(['_trackEvent', 'Credit', 'Solicitare-Trimisa']);" type="submit" value="<?php echo $button_credit; ?>" id="button-cart" class="button credit-button" style="width: 188px;height: 40px;margin-right: 47px;margin-top: 20px;float: right; margin-bottom:20px;font-size: 22px !important;" />
</div></div>                    
</form>  
<?php } else { ?>
...
$('.required').blur(function() {
  ...
  if (empty_flds) {
		...
		$('#button-cart').bind('click', function() {
			$.ajax({ 
				type: 'GET',
				url: 'index.php?route=payment/bycredit/confirm',
				success: function() {
					location = '//smart.md/credit/credit.php';
				}		
			});
		});
  }
