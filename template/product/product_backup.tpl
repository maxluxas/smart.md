           ...
           <?php if ($product_id==16617) { ?>
            ...
            <script type="text/javascript">
                ...
                function runFunction(){
                  var d = new Date();
                  var d2 = new Date(2016, 8, 10, 24, 0,0,0);
                  var milSec = d2-d;
                  var d3 = new Date(milSec);
                    ...
                    if(nrHours<10){nrHours = '0'+nrHours;}
                    if(nrDays<10){nrDays = '0'+nrDays;}

                  document.getElementById("zile").innerHTML = nrDays;
                  document.getElementById("ore").innerHTML = nrHours;
                  document.getElementById("minute").innerHTML = nrMin;
                  document.getElementById("secunde").innerHTML = nrSec;
                }
              </script>
              <aside id="Special_baner">
                <div id="Timer" style="width:100%">
                  <h2 id="timpul_ramas"><?=$oferta_expira?></h2>
                     <div class="row count_row" style="width:35%">
                       <span class="col s3">
                          <span id="zile">00</span>
                          <span class="text_ind"><?=$oferta_expira_day?></span>
                       </span>
                       <span class="col s3">
                          <span id="ore">00</span>
                          <span class="text_ind"><?=$oferta_expira_hours?></span>
                       </span>
                       <span class="col s3">
                          <span id="minute">00</span>
                          <span class="text_ind"><?=$oferta_expira_min?></span>
                       </span>
                       <span class="col s3">
                          <span id="secunde">00</span>
                          <span class="text_ind"><?=$oferta_expira_sec?></span>
                       </span>
                     </div>
                </div>
              </aside>
          ...
          <!-- END CREDIT -->
              ...
              <div class="row call_port">
                <div class="col m6">
                  ...
                  <div class="cerc_social call waves-effect waves-light" style="border:2px solid #fff !important;"><span><i class="iicon-ic_phone_black_24px"></i></span></div>
                  <p class="descript_func"><?php echo $apel; ?></p>
                  </a>
                </div>
                <div class="col m6">
        ...
        <div class="row">
          ...
          <? if(!$other_background): ?>
            ...
            /* telefoane */
              ...
              .phot_cont2{margin-top: 3%;background: url(<?=$url_2_image?>);background-size: cover;}
            <? else: ?>
    ...
    <div class="row descriere_row opp_row">
      ...
      <div class="row">
          ...
          <div id="opinii_produs" class="col s12">
            ...
            <!-- opinii-->
            <aside id="lasa_opinia_cont_prod" <?php if (isset($_COOKIE['Social'])) { ?>class="opp_open"<?php } ?> >
          ...
          <div id="opinii_companie" class="col s12" style="display:none;">Al doilea</div>
        </div>
      <div class="col m4 noneuse"></div>
      </article>
      </aside>
