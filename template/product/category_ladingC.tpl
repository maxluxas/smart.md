<link rel="stylesheet" href="catalog/view/smartv3/css/category-landing.css?v=0.0.47"/>
...
<div class="__new_content_home __categories_landing">
    <div class="__new_content_center_align">
        ...
        <div class="__new_categories_home">
            ...
            <div class="__new_categories_home_block1 __new_categories_home_block1_laptop" <?php if(!isset($has_products)) { ?> style="margin-bottom: 200px;" <?php } ?>>
