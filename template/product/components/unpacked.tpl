<?php if($existunpacked) { ?>
    <?php foreach($unpacked as $pack) { ?>
          ...
          <div class="__new_resigilat_block_content">
            <div class="__new_resigilat_details">
              ...
              <div class="__new_pr_resigilat">
                ...
                <span class="__new_resigilat_label"><?php echo $utilizat; ?></span>
              </div>
            </div>
            <div class="__new_resigilat_atuu">
              <div class="__new_resigilat_atuu_1">
                ...
                <span class="__new_atuu_text"><?php echo $economiseste_unpack; ?> <?php echo $pack['econom']; ?> <?php echo $product_currency; ?></span>
              </div>
        ...
        <div class="__new_resigilat_block_mobile">
          <span class="__new_resigilat_utilizat"><?php echo $utilizat; ?> </span>
