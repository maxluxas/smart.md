                ...
                <div class="order-history-info">
                    ...
                    <div class="order-content">
                      ...
                      <div class="order-info">
                        <a href="<?php echo $order['href']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo $button_view; ?>"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                        <a href="<?php echo $order['reorder']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo $button_reorder; ?>"><i class="icon-undo"></i></a></div>
                    </div>
                    </div>
                    <?php } ?>
