...
<div class="mobile-view carousel_featured">
	...
	<?php } ?>
	<div class="mobile-view see-more"><a class="waves-effect yellow black-text waves-light btn btn-medium button"href="//www.smart.md/foto/slr-photo">Vezi mai multe</a></div>
</div>
