...
<div class="mobile-view carousel_featured">
	...
	<?php } ?>
	<div class="mobile-view see-more"><a class="waves-effect yellow black-text waves-light btn btn-medium button"href="//www.smart.md/tv/tv-1">Vezi mai multe</a></div>
</div>
...
<a href="//smart.md/livrare.html"><img class="img_promo" src="image/promo/promo_banners/promo_livrare_<?php echo $promo_img; ?>" /></A>
<style>
