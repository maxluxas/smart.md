...
<!--img src="image/promo/promo_banners/promo_paste_<?php echo $promo_img; ?>" /-->
<a href="//www.smart.md/telefoane/smartphone/smartphone_apple-iphone-se-16gb-rose-gold.html"><img src="image/data/slide2016/iphone-se-oferte-980x205-<?php echo $promo_img; ?>.jpg" class="img_promo" width="980" /></a>
<div class="mobile-view carousel_featured">
	...
	<?php } ?>
	<div class="mobile-view see-more"><a class="waves-effect yellow black-text waves-light btn btn-medium button" href="//www.smart.md/telefoane/smartphone">Vezi mai multe</a></div>
</div>
