												...
												<ul class="mfilter-tb" data-top-url="<?php echo $filter['top_url']; ?>" data-top-path="<?php echo $filter['top_path']; ?>">
													<?php foreach( $filter['categories'] as $category ) { ?>
														...
														<li class="mfilter-tb-as-tr">
															...
															<div class="mfilter-tb-as-td mfilter-col-count"><span class="mfilter-counter"<?php echo $category['cnt'] < 0 ? ' style="display:none"' : ''; ?>><?php echo $category['cnt']; ?></span></div>
														</li>
													<?php } ?>
												</ul>
											<?php } ?>
	...
	jQuery().ready(function(){
		jQuery('#mfilter-box-<?php echo (int) $_idx; ?>').each(function(){
			...
			MegaFilterINSTANCES.push((new MegaFilter()).init( _t, {
				...
				'routeManufacturerList'	: '<?php echo $_routeManufacturerList; ?>',
				...
				'aceshop'				: <?php echo $ace_shop ? 'true' : 'false'; ?>,
