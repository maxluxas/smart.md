...
<a href="//www.smart.md/laptopuri/notebook?product_id=15644"><img src="image/data/promo/feb2016/lenovo-ideapad-100-oferte-980x205-<?php echo $lang_img; ?>.jpg" class="img_promo" width="980" /></a>
<div class="mobile-view carousel_featured">
	<div style="color: #333;font-size: 34px;"><?php echo $promo_title; ?></div>
	...
	<?php } ?>
	<div class="mobile-view see-more"><a class="waves-effect yellow black-text waves-light btn btn-medium button"href="//www.smart.md/laptopuri/notebook">Vezi mai multe</a></div>
</div>
