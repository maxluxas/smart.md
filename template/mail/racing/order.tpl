...
<div style="background-color:#F5F5F5; margin:0; padding:0; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">
<div style="width:100%; padding-top:30px; padding-bottom:30px; background-color:#EFEFEF; text-align:center; border-bottom:3px solid #C12222;">
    <a href="<?php echo $store_url; ?>" style="text-decoration:none; font-size:22px; color:#333333;"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="border:none;" /></a>
</div>
<div style="margin-left:auto; margin-right:auto; max-width:500px; min-width:280px; padding:20px 20px 20px 20px; background-color:#FFFFFF;">
    <div style="font-size:14px; line-height:22px; border-bottom:2px solid #DEDEDE; padding:0 10px 10px 10px;"><?php echo $text_greeting; ?></div>
	<?php if ($customer_id) { ?>
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
    	<img src="<?php echo $store_url; ?>catalog/view/tranda_root/stylesheet/img/email_customer_id.png" style="float:left; margin:0 10px 0 0;">
        <?php echo $text_link; ?><br />
        <a href="<?php echo $link; ?>" style="color:#C12222; text-decoration:none;"><?php echo $link; ?></a>
    </div>
	<?php } ?>
	<?php if ($download) { ?>
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
    	<img src="<?php echo $store_url; ?>catalog/view/tranda_root/stylesheet/img/email_download.png" style="float:left; margin:0 10px 0 0;">
        <?php echo $text_download; ?><br />
        <a href="<?php echo $download; ?>" style="color:#C12222; text-decoration:none;"><?php echo $download; ?></a>
    </div>
	<?php } ?>
    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <?php } ?></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_email; ?></b> <a href="mailto:<?php echo $email; ?>" style="color:#333333; text-decoration:none;"><?php echo $email; ?></a><br />
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 0;">
    <thead>
      <tr>
...
<div style="width:100%; background-color:#333333; text-align:center; border-top:3px solid #DEDEDE; border-bottom:3px solid #C12222;">
    <p style="margin:0; padding-top:10px; padding-bottom:10px; color:#CCCCCC; line-height:19px;"><?php echo $text_footer; ?></p>
</div>
<p style="text-align:center; font-size:11px; margin:0; padding:5px 0 5px 0;"><?php echo $text_powered; ?></p>
</div>
</body>
</html>
