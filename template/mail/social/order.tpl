...
<div style="width:100%; padding-top:30px; padding-bottom:30px; background-color:#FFFFFF; text-align:center; border-bottom:3px solid #3B5998;">
    <a href="<?php echo $store_url; ?>" style="text-decoration:none; font-size:22px; color:#3B5998;"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="border:none;" /></a>
</div>
<div style="margin-left:auto; margin-right:auto; max-width:500px; min-width:280px; padding:20px 20px 20px 20px; background-color:#FFFFFF;">
    ...
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
        ...
        <a href="<?php echo $link; ?>" style="color:#3B5998; text-decoration:none;"><?php echo $link; ?></a>
    </div>
	<?php } ?>
	<?php if ($download) { ?>
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
        ...
        <a href="<?php echo $download; ?>" style="color:#3B5998; text-decoration:none;"><?php echo $download; ?></a>
    </div>
	<?php } ?>
...
<div style="width:100%; background-color:#A7B4D1; text-align:center; border-top:3px solid #DEDEDE; border-bottom:3px solid #3B5998;">
    <p style="margin:0; padding-top:10px; padding-bottom:10px; color:#333333; line-height:19px;"><?php echo $text_footer; ?></p>
</div>
