...
<div style="width:100%; padding-top:30px; padding-bottom:30px; background-color:#4B4B4B; text-align:center; border-bottom:3px solid #94BE21;">
...
<div style="margin-left:auto; margin-right:auto; max-width:500px; min-width:280px; padding:20px 20px 20px 20px; background-color:#FFFFFF;">
    ...
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
        ...
        <a href="<?php echo $link; ?>" style="color:#94BE21; text-decoration:none;"><?php echo $link; ?></a>
    </div>
	<?php } ?>
	<?php if ($download) { ?>
    <div style="overflow:auto; line-height:19px; background-color:#F5F5F5; padding:15px;">
        ...
        <a href="<?php echo $download; ?>" style="color:#94BE21; text-decoration:none;"><?php echo $download; ?></a>
    </div>
	<?php } ?>
...
<div style="width:100%; background-color:#4B4B4B; text-align:center; border-top:3px solid #DEDEDE; border-bottom:3px solid #94BE21;">
