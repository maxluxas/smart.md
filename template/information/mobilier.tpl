    ...
    <div class="__new_content_center_align">
          ...
          <div class="__new_search_results">
            ...
            <div class="__new_search_results_categories">
             ...
             <!--  <form method="POST" onsubmit="return false;">
                ...
                <input type="hidden" name="categ-produs" value="Mobilier Lading">
      ...
      <div class="__new_categories_home">
        <div class="__new_categories_home_block1">
          ...
          <a href="ikea" not-menu="yes" id="__new_open_smartphone" class="__new_category_home __new_category_mobila">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/ikea-image-new.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_ikea; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <a href="saltele" not-menu="yes" id="__new_open_laptop" class="__new_category_home __new_category_mobila">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/saltele.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_saltele; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <a href="scaune" not-menu="yes" id="__new_open_electrocasnice" class="__new_category_home __new_category_mobila">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/scaun.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_scaune; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <a href="paturi" not-menu="yes" id="__new_open_mobilier" class="__new_category_home __new_category_mobila">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/paturi.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_paturi; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <a href="dulapuri" not-menu="yes" id="__new_open_tv" class="__new_category_home __new_category_mobila">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/dulapuri.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_dulapuri; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <a href="canapele" not-menu="yes" id="__new_open_gadget" class="__new_category_home __new_category_mobila __new_desktop_only">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_mobilier/canapele.png">
            </div>
            <span class="__new_category_home_name"><?php echo $new_mob_canapele; ?></span>

            <div class="__new_main_categories_menu"></div>
          </a>

          <div id="__new_open_all_categories_mobile" class="__new_category_home __new_category_mobila __new_mobile_only">
            <div class="__new_categories_image_container">
              <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png">
            </div>
            <span class="__new_category_home_name" menu_lv="<?= $menu_items[13]['level']; ?>" menu_id="<?= $menu_items[13]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
          </div>
