    ...
    <div class="__new_content_center_align">
            ...
            <div class="__new_search_results">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <!--  <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Telefoane Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1">
                <a href="smartphone" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/smartphone.png" alt="Cumpără smartphone" />
                    </div>
                ...
                <a href="smartphone?filter=2=336" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/smartphone-xiaomi.png" alt="Cumpără smartphone Xiaomi" />
                    </div>
                ...
                <a href="smartphone?filter=2=4" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/smartphone-samsung.png" alt="Cumpără smartphone Samsung" />
                    </div>
                ...
                <a href="smartphone?filter=2=5" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/smartphone-apple.png" alt="Cumpără smartphone Apple" />
                    </div>
                ...
                <a href="telefoane-ieftine" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/telefoane-cu-butoane.png" alt="Cumpără telefoane cu butoane" />
                    </div>
                ...
                <a href="telefoane-utilizate" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/telefoane/utilizate.png" alt="Cumpără smartphone utilizate" />
                    </div>
                ...
                <div id="__new_open_all_categories_mobile" class="__new_category_home __new_mobile_only __new_telefoane">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="menu categorie" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[23]['level']; ?>" menu_id="<?= $menu_items[23]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
                </div>
