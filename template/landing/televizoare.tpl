...
<link rel="stylesheet" href="catalog/view/smartv3/css/landing.css?v=0.0.8"/>
...
<div class="__new_content_home">
    <div class="__new_content_center_align">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <div class="__new_search_not_found"><?php echo $nu_a_gasit; ?>
                  <!-- <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Televizoare Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1 __new_categories_home_block1_tv">
                <a href="televizoare" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare.png" alt="Cumpără un Televizor nou" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_1; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="televizoare?filter=31=1638" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-hisense.png" alt="Cumpara Televizoare Hisense" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_2; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="televizoare?filter=31=161" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-lg.png" alt="Cumpara Televizoare LG" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_3; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="televizoare?filter=31=162" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-samsung.png" alt="Cumpara Televizoare Samsung" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_4; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <div id="__new_open_tv" not-menu="no" class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/accesorii-tv.png" alt="Accesorii TV" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[24]['level']; ?>" menu_id="<?= $menu_items[24]['menu_id']; ?>"><?php echo $new_tab_5; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>

                <a href="televizoare?filter=528=4753" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-credit-0.png" alt="Cumpara Televizoare in Credit 0%" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_6; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="televizoare?filter=36=180" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/smart-tv.png" alt="Cumpara Smart TV" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_7; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>
                <a href="televizoare?sort=p.price&order=ASC" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-ieftine.png" alt="Cumpara Televizoare ieftine" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_8; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>
                <a href="televizoare?filter=33=4923" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_tv">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/televizoare/televizoare-43.png" alt="Cumpara Televizoare 43''" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_9; ?></span>
