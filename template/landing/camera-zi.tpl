...
<link rel="stylesheet" href="catalog/view/smartv3/css/landing.css?v=0.0.31"/>
    ...
    <div class="__new_content_center_align">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <div class="__new_search_not_found"><?php echo $nu_a_gasit; ?>
                  <!-- <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Camera de zi Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1">
                <a href="canapele" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/canapele-si-coltare.png" alt="Cumpără canapele si coltare" />
                    </div>
                ...
                <a href="dulapuri" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/dulapuri.png" alt="Cumpără dulapuri" />
                    </div>
                ...
                <a href="seturi-living" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/seturi-living.png" alt="Cumpără seturi living" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="1" menu_id="4"><?php echo $new_tab_3; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="comode" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/comode.png" alt="Cumpără comode" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="1" menu_id="6"><?php echo $new_tab_4; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <a href="rafturi-si-etajere" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/rafturi-si-etajiere.png" alt="Cumpără rafturi si etajiere" />
                    </div>
                ...
                <a href="biblioteci" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/camera-de-zi/biblioteci.png" alt="Cumpără biblioteci" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="1" menu_id="9"><?php echo $new_tab_6; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                
                <div id="__new_open_all_categories_mobile" class="__new_category_home __new_mobile_only __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[14]['level']; ?>" menu_id="<?= $menu_items[14]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
                </div>
                
            </div>
            <div class="__new_categories_home_block2">
                <div id="__new_open_all_categories" class="__new_category_home __new_desktop_only __new_camera_zi">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[14]['level']; ?>" menu_id="<?= $menu_items[14]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
