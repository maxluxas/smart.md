...
<link rel="stylesheet" href="catalog/view/smartv3/css/landing.css?v=0.0.13"/>
...
<div class="__new_content_home">
    <div class="__new_content_center_align">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <div class="__new_search_not_found"><?php echo $nu_a_gasit; ?>
                  <!-- <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="laptopuri Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1 __new_categories_home_block1_laptop">
                <a href="laptopuri" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/laptop.png" alt="Laptop" />
                    </div>
                ...
                <a href="all-in-one" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/pc.png" alt="PC" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="1" menu_id="3"><?php echo $new_tab_2; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <div id="__new_open_electrocasnice" not-menu="no"  class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/console.png" alt="Console" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[18]['level']; ?>" menu_id="<?= $menu_items[18]['menu_id']; ?>"><?php echo $new_tab_3; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>

                <div id="__new_open_mobilier" not-menu="no" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/tablete-si-ebooks.png" alt="Tablete si e-books" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[19]['level']; ?>" menu_id="<?= $menu_items[19]['menu_id']; ?>"><?php echo $new_tab_4; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>

                <a href="monitoare" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/monitoare.png" alt="Monitoare" />
                    </div>
                    <span class="__new_category_home_name"><?php echo $new_tab_5; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </a>

                <div id="__new_open_gadget" not-menu="no" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/imprimante.png" alt="Imprimante" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[20]['level']; ?>" menu_id="<?= $menu_items[20]['menu_id']; ?>"><?php echo $new_tab_6; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>

                <div id="__new_open_tv" not-menu="no" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/componente-pc.png" alt="Componente PC" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[21]['level']; ?>" menu_id="<?= $menu_items[21]['menu_id']; ?>"><?php echo $new_tab_7; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>
                <div id="__new_open_tv" not-menu="no" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/foto-video.png" alt="Foto & Video" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[22]['level']; ?>" menu_id="<?= $menu_items[22]['menu_id']; ?>"><?php echo $new_tab_8; ?></span>

                    <div class="__new_main_categories_menu"></div>
                </div>
                <a href="index.php?route=product/category&path=4477" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_laptop">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/laptopuri/refurbished.png" alt="Refurbished" />
                    </div>
