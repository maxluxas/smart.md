    ...
    <div class="__new_content_center_align">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <div class="__new_search_not_found"><?php echo $nu_a_gasit; ?>
                  <!-- <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Bucatarii Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1">
                <a href="bucatarii" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/bucatarii.png" alt="Cumpără bucatarii" />
                    </div>
                ...
                <a href="scaune" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/scaune.png" alt="Cumpără scaune" />
                    </div>
                ...
                <a href="mese-bucatarie" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/mese-bucatarie.png" alt="Cumpără mese bucatarie" />
                    </div>
                ...
                <a href="coltare-pentru-bucatarie" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/coltare-pentru-bucatarie.png" alt="Cumpără coltare pentru bucatarie" />
                    </div>
                ...
                <a href="set-mese-si-scaune" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/seturi-mese-si-scaune.png" alt="Cumpără seturi mese si scaune" />
                    </div>
                ...
                <a href="chiuvete" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/bucatarii/chiuvete.png" alt="Cumpără chiuvete" />
                    </div>
                ...
                <div id="__new_open_all_categories_mobile" class="__new_category_home __new_mobile_only __new_bucatarie">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="menu categorie" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[15]['level']; ?>" menu_id="<?= $menu_items[15]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
                </div>
