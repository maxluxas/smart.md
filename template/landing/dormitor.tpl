    ...
    <div class="__new_content_center_align">
            ...
            <div class="__new_search_results">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <!--  <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Dormitor Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1">
                <a href="saltele" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/saltele.png" alt="Cumpara saltele" />
                    </div>
                ...
                <a href="paturi" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/paturi.png" alt="Cumpara paturi" />
                    </div>
                ...
                <a href="dormitoare" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/dormitoare.png" alt="Cumpara dormitoare" />
                    </div>
                ...
                <a href="dulapuri" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/dulapuri.png" alt="Cumpara dulapuri" />
                    </div>
                ...
                <a href="comode" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/comode.png" alt="Cumpara comode" />
                    </div>
                ...
                <a href="noptiere" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/dormitoare/noptiere.png" alt="Cumpara noptiere" />
                    </div>
                ...
                <div id="__new_open_all_categories_mobile" class="__new_category_home __new_mobile_only __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="menu categorie" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[16]['level']; ?>" menu_id="<?= $menu_items[16]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
                </div>
                
            </div>
            <div class="__new_categories_home_block2">
                <div id="__new_open_all_categories" class="__new_category_home __new_desktop_only __new_dormitor">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="menu categorie" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[16]['level']; ?>" menu_id="<?= $menu_items[16]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
