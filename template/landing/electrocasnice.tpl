    ...
    <div class="__new_content_center_align">
                ...
                <div class="__new_search_results_categories">
                 ...
                 <div class="__new_search_not_found"><?php echo $nu_a_gasit; ?>
                  <!-- <form method="POST" onsubmit="return false;">
                    ...
                    <input type="hidden" name="categ-produs" value="Electrocasnice Lading">
        ...
        <div class="__new_categories_home">
            <div class="__new_categories_home_block1">
                <a href="aspiratoare" id="__new_open_smartphone" not-menu="yes" class="__new_category_home __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/aspirator.png" alt="Cumpără aspirator" />
                    </div>
                ...
                <a href="masini-de-spalat-rufe" id="__new_open_laptop" not-menu="yes" class="__new_category_home __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/masini-de-spalat.png" alt="Cumpără masini de spalat" />
                    </div>
                ...
                <a href="frigidere" id="__new_open_electrocasnice" not-menu="yes"  class="__new_category_home __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/frigidere.png" alt="Cumpără frigidere" />
                    </div>
                ...
                <a href="boilere" id="__new_open_mobilier" not-menu="yes" class="__new_category_home __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/boilere.png" alt="Cumpără boilere" />
                    </div>
                ...
                <a href="cazane" id="__new_open_tv" not-menu="yes" class="__new_category_home __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/cazane.png" alt="Cumpără cazane" />
                    </div>
                ...
                <a href="aeroterme" id="__new_open_gadget" not-menu="yes" class="__new_category_home __new_desktop_only __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_landing/electrocasnice/aeroterme.png" alt="Cumpără aeroterme" />
                    </div>
                ...
                <div id="__new_open_all_categories_mobile" class="__new_category_home __new_mobile_only __new_electrocasnice">
                    <div class="__new_categories_image_container">
                        <img class="__new_category_home_image" src="catalog/view/smartv3/img/__new_home/Toate-Catgoriile.png" alt="menu categorie" />
                    </div>
                    <span class="__new_category_home_name" menu_lv="<?= $menu_items[17]['level']; ?>" menu_id="<?= $menu_items[17]['menu_id']; ?>"><?php echo $new_toate_categ; ?></span>
                </div>
